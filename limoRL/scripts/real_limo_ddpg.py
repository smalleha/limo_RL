...
if __name__=='__main__':
    ...
    for e in range(agent.start_epoch+1,50000):
        ...
        for t in range(episode_step):
            ...
            # if episode_reward_sum > last_score:
            #     rospy.loginfo(f"New high score {episode_reward_sum:.2f} > last {last_score:.2f}, stopping car and ending episode.")
            #     # 立即停车
        ...
        # # 更新 last_score，仅当本回合得分优于历史最高时
        # if episode_reward_sum > last_score:
        #     last_score = episode_reward_sum
